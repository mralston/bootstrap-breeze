...
class InstallCommand extends Command
{
    ...
    /**
     * Install the Inertia-Bootstrap-Vue Breeze stack.
     *
     * @return void
     */
    protected function installInertiaVueBootstrapStack()
    {
        // Install Inertia...
        ...
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia-vue-bootstrap/resources/js/Components', resource_path('js/Components'));
        (new Filesystem)->copyDirectory(__DIR__.'/../../stubs/inertia-vue-bootstrap/resources/js/Layouts', resource_path('js/Layouts'));
